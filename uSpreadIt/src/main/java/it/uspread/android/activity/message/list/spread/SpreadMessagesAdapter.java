...
/**
 * Gestion de l'affichage des éléments de la liste des message propagé par l'utilisateur.
 *
 * @author Lone Décosterd,
 */
public class SpreadMessagesAdapter extends ListElementAdapter<Message> {
     ...
     *         Contexte
     */
    public SpreadMessagesAdapter(final Context context) {
